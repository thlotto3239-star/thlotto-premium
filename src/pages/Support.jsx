...
const FAQ_ITEMS = [
  ...
  {
    q: 'ลืมรหัส PIN 6 หลัก สำหรับถอนเงิน ต้องทำอย่างไร?',
              ...
              <div className="flex gap-2 overflow-x-auto no-scrollbar pt-1">
                {[
                  ...
                  <button
                    ...
                    className={`shrink-0 px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${selectedCategory === cat.id
